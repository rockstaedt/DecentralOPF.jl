...
# ╔═╡ 19d6f602-9e7d-47d3-a672-79a365761a2f
using JuMP 

# ╔═╡ 2cd4cb21-6dd1-45e5-9ab5-502cfc5a0582
begin
	using Gurobi
	using Images
	using ImageShow
...
# ╔═╡ f4876900-2291-11ec-154e-8532bb0bc114
md"Set-up:"

# ╔═╡ 3df39ece-71b1-4c82-8d82-121f54aa8ca6
"""
...
# ╔═╡ 2486f787-ae84-4288-b134-cb3280c71cdb


# ╔═╡ 3bf31051-5eb4-4cea-97ac-8796cfa93d09


# ╔═╡ f629233f-6567-4012-b29c-dd61d930b553
md"Using this exmaple system of three nodes and four generators:"

# ╔═╡ 6e141631-a84e-4779-90ff-d762c7fceb9a
begin
	filepath = pwd()*"/img/example-system.png"
	load(filepath)
end

# ╔═╡ bdbfaae0-e6d4-49d0-9943-dcea3431551c
begin
	P = ["pv", "gas", "wind", "coal"];
	N = ["N1", "N2", "N3"];
	L = ["L1", "L2", "L3"];
...
# ╔═╡ bc378092-f01a-4047-9526-b704d4d9ef27
plants = join(P, ", ")

# ╔═╡ dd012257-3b89-490e-807b-ca76f1d15fa0
md"Set definitions: 
...
# ╔═╡ cacefd6c-9cec-4db5-930e-b939ccdd7256


# ╔═╡ d3f23aaa-4741-4b39-b967-c179357dc766


# ╔═╡ 587e2546-986d-409d-a4f4-4e432a73d1ec


# ╔═╡ f60c987a-3d7b-494c-818a-7b4b6bf295cb


# ╔═╡ a8203479-5418-4be9-94d0-86a8ff2af2f3
begin
...
# ╔═╡ a8f7b6bb-73fd-46ee-a145-31b4adba7266


# ╔═╡ 06a98e12-4c6b-4f2e-b767-4217df523b0c
md"Defining the dispatch problem:"

# ╔═╡ 2b170593-61bb-4c45-a5f5-32ab0bfb176a
begin
	...
	@constraint(dispatch, EnergyBalance[n=N], 
		demand[n] - sum(G[p] for p in map_pn[n]) == I[n]);
...
# ╔═╡ f78ed802-523c-4666-9206-91cecfb7471e
convert_jump_container_to_df(I, dim_names=[:Nodes], value_col=Symbol("net-injetion"))

# ╔═╡ 411a89b5-c059-4c5b-865e-713eb0affa22
convert_jump_container_to_df(G, dim_names=[:Plants], value_col=Symbol("generation"))

# ╔═╡ fe28c7fa-0ec9-4940-b9f6-38c8f5ce6bb3


# ╔═╡ 6d8049dc-3954-4fd3-9e6f-2c863fa3b83f


# ╔═╡ 3cd13f93-2402-4331-9e35-a38c176b4ef6


# ╔═╡ 383ed517-b25c-4001-a94f-1159fb07c7e2


# ╔═╡ cf89c554-a9ad-452e-bdff-0412061cfb2e


# ╔═╡ a78e0370-6775-4b77-80f1-3209b1ba101e


# ╔═╡ a8cb08d9-e1f7-4bab-8bdf-f911b5284239


# ╔═╡ 7ae6b8b5-24e1-422e-a6a0-0f8aad56aabc


# ╔═╡ 8107466b-4260-437d-950a-7f31565cc558


# ╔═╡ c5ff8deb-9a65-4cdb-931a-d90d20e4d847


# ╔═╡ 01c051ac-a942-4e02-a85b-50c66f6fb7b0


# ╔═╡ 14adce8c-e929-4bc7-9358-2115f3f7d75a


# ╔═╡ 4661fef0-b6ad-4037-9291-5ccb700c672c


# ╔═╡ b3d01605-a9fd-4bbc-a88e-9f97d1d579da


# ╔═╡ f1d651f3-5477-43bc-a056-5209c084f39b


# ╔═╡ 3dfbe84c-585f-48c1-b5ab-58e83d665601


# ╔═╡ 7e5c6dbf-f49c-46c9-bceb-8f3785f71c5b


# ╔═╡ cad2a41e-edf9-4d8b-95c2-3a987ce52f00


# ╔═╡ 00781662-045c-4efe-b675-e787c15388cb


# ╔═╡ 03eb1cc3-bac1-4abe-8ec9-f54d642b42ac


# ╔═╡ bd8bccb4-e52b-4ce8-9f25-ad191b0c8365


# ╔═╡ 9fd621a6-7a37-46e0-9019-863bbaa7f4fc


# ╔═╡ 80c1eec2-a6c4-4da1-bd3f-43238c502ecf


# ╔═╡ d5888129-624f-40e2-a54a-a562ad777985


# ╔═╡ f5ccee16-fee7-46e8-a967-8ea087039149


# ╔═╡ a8d51cc2-1813-4f6c-928e-38b7c58a4c57


# ╔═╡ 85578be5-bedd-4e00-924d-2db3d3a8491b


# ╔═╡ db0eed68-5668-47b8-880c-e409c4dab239


# ╔═╡ d10f8e9f-8182-4d61-8737-653f6c716979


# ╔═╡ 3fcbe159-d4cc-4757-9e86-e681089526fd
